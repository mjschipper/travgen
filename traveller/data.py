...
HOSTILE_WORLDS = {"Earth": ["Life Science", "Computers", "Streetwise", "Carouse"],
          "Off-World Colony": ["Vacc Suit", "Survival", "Melee (blade)", "Drive"]}
...
SKILLS = {
    ...
    ("Corporate Agent", "Intelligence"): (("Gun Combat", 0), ("Vacc Suit", 0), ("Drive", 0), ("Streetwise", 0), ("Gun Combat", 0), ("Recon", 0),
                ("Str", 1), ("Dex", 1), ("Persuade", 0), ("Int", 1), ("Edu", 1), ("Soc", 1),
                ("Deception", 0), ("Investigate", 0), ("Computers", 0), ("Carouse", 0), ("Comms", 0), ("Jack of all Trades", 0),
                ("Medic", 0), ("Sensors", 0), ("Admin", 0), ("Computers", 0), ("Leadership", 0), ("Tactics", 0)),
    ("Corporate Executive", "ICO"): (("Gambler", 0), ("Admin", 0), ("Carouse", 0), ("Leadership", 0), ("Persuade", 0), ("Deception", 0),
                ("Streetwise", 0), ("Int", 1), ("Edu", 1), ("Soc", 1), ("Carouse", 0), ("Persuade", 0),
                ("Broker", 0), ("Diplomat", 0), ("Drive", 0), ("Broker", 0), ("Computers", 0), ("Leadership", 0),
                ("Medic", 0), ("Computers", 0), ("Admin", 0), ("Diplomat", 0), ("Leadership", 0), ("Jack of all Trades", 0)),
    ("Colonist", "UCC"): (("Mechanic", 0), ("Gun Combat", 0), ("Life Science", 0), ("Electronics", 0), ("Survival", 0), ("Drive", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Int", 1), ("Melee (unarmed)", 0), ("Gun Combat", 0),
                ("Drive (loader)", 0), ("Carouse", 0), ("Jack of all Trades", 0), ("Engineer", 0), ("Life Science", 0), ("Drive", 0),
                ("Medic", 0), ("Life Science", 0), ("Jack of all Trades", 0), ("Diplomat", 0), ("Admin", 0), ("Leadership", 0)),
    ("Commercial Spacer", "Wanderer"): (("Comms", 0), ("Persuade", 0), ("Gun Combat", 0), ("Drive (loader)", 0), ("Broker", 0), ("Drive", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Str", 1), ("Melee (unarmed)", 0), ("Vacc Suit", 0),
                ("Vacc Suit)", 0), ("Mechanic", 0), ("Drive (loader)", 0), ("Electronics", 0), ("Steward", 0), ("Navigation", 0),
                ("Medic", 0), ("Computers", 0), ("Broker", 0), ("Pilot", 0), ("Engineer", 0), ("Navigation", 0)),
    ("Marine", "USMC"): (("Drive", 0), ("Vacc Suit", 0), ("Gun Combat", 0), ("Survival", 0), ("Gun Combat", 0), ("Vacc Suit", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Gambler", 0), ("Melee (unarmed)", 0), ("Melee (blade)", 0),
                ("Drive", 0), ("Mechanic", 0), ("Electrical", 0), ("Explosives", 0), ("Recon", 0), ("Heavy Weapons", 0),
                ("Medic", 0), ("Tactics", 0), ("Tactics", 0), ("Computers", 0), ("Leadership", 0), ("Admin", 0)),
    ("Marshal", "Colonial Marshal"): (("Streetwise", 0), ("Melee (unarmed)", 0), ("Melee (unarmed)", 0), ("Investigate", 0), ("Recon", 0), ("Gun Combat", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Int", 1), ("Edu", 1), ("Soc", 1),
                ("Gun Combat", 0), ("Comms", 0), ("Drive", 0), ("Sensors", 0), ("Computers", 0), ("Medic", 0),
                ("Medic", 0), ("Tactics", 0), ("Investigate", 0), ("Computers", 0), ("Tactics", 0), ("Admin", 0)),
    ("Military Spacer", "PMC"): (("Vacc Suit", 0), ("Computers", 0), ("Vacc Suit", 0), ("Gunner", 0), ("Melee (unarmed)", 0), ("Gun Combat", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Int", 1), ("Edu", 1), ("Soc", 1),
                ("Gunner", 0), ("Mechanic", 0), ("Electronics", 0), ("Engineer", 0), ("Gunner", 0), ("Comms", 0),
                ("Medic", 0), ("Navigation", 0), ("Engineer", 0), ("Computers", 0), ("Pilot", 0), ("Admin", 0)),
    ("Physician", "Medical"): (("Dex", 1), ("Electronics", 0), ("Medic", 0), ("Streetwise", 0), ("Medic", 0), ("Investigate", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Int", 1), ("Edu", 1), ("Soc", 1),
                ("Diplomat", 0), ("Investigate", 0), ("Mechanic", 0), ("Electronics", 0), ("Computers", 0), ("Admin", 0),
                ("Diplomat", 0), ("Medic", 0), ("Admin", 0), ("Computers", 0), ("Int", 1), ("Edu", 1)),
    ("Ranger", "Action for Peace"): (("Gun Combat", 0), ("Gun Combat", 0), ("Survival", 0), ("Recon", 0), ("Drive", 0), ("Survival", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Int", 1), ("Gun Combat", 0), ("Melee (blade)", 0),
                ("Mechanic", 0), ("Electronics", 0), ("Comms", 0), ("Recon", 0), ("Drive", 0), ("Survival", 0),
                ("Medic", 0), ("Computers", 0), ("Jack of all Trades", 0), ("Leadership", 0), ("Medic", 0), ("Mechanic", 0)),
    ("HOS_Rogue", "Enforcer"): (("Melee (blade)", 0), ("Gun Combat", 0), ("Melee (unarmed)", 0), ("Drive", 0), ("Recon", 0), ("Drive", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Melee (unarmed)", 0), ("Melee (blade)", 0), ("Carouse", 0),
                ("Streetwise", 0), ("Persuade", 0), ("Deception", 0), ("Explosives", 0), ("Sensors", 0), ("Melee (blade)", 0),
                ("Tactics", 0), ("Persuade", 0), ("Deception", 0), ("Computers", 0), ("Leadership", 0), ("Jack of all Trades", 0)),
    ("Roughneck", "Freelance Miner"): (("Vacc Suit", 0), ("Mining", 0), ("Vacc Suit", 0), ("Explosives", 0), ("Comms", 0), ("Drive", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Gambler", 0), ("Vacc Suit", 0), ("Melee (unarmed)", 0),
                ("Streetwise", 0), ("Electronics", 0), ("Drive", 0), ("Mechanic", 0), ("Mining", 0), ("Mechanic", 0),
                ("Navigation", 0), ("Medic", 0), ("Electronics", 0), ("Computers", 0), ("Engineer", 0), ("Jack of all Trades", 0)),
    ("Scientist", "ICO"): (("Gun Combat", 0), ("Comms", 0), ("Investigate", 0), ("Drive", 0), ("Comms", 0), ("Survival", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Int", 1), ("Edu", 1), ("Int", 1),
                ("Mechanic", 0), ("Electronics", 0), ("Vacc Suit", 0), ("Computers", 0), ("Investigate", 0), ("Drive", 0),
                ("Medic", 0), ("Computers", 0), ("Admin", 0), ("Leadership", 0), ("Navigation", 0), ("Jack of all Trades", 0)),
    ("Survey Scout", "MRA"): (("Drive", 0), ("Vacc Suit", 0), ("Mechanic", 0), ("Mining", 0), ("Comms", 0), ("Mining", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Int", 1), ("Edu", 1), ("Gun Combat", 0),
                ("Drive", 0), ("Mechanic", 0), ("Electronics", 0), ("Investigate", 0), ("Gunner", 0), ("Medic", 0),
                ("Medic", 0), ("Navigation", 0), ("Engineer", 0), ("Computers", 0), ("Pilot", 0), ("Jack of all Trades", 0)),
    ("Technician", "Freelance Miner"): (("Drive", 0), ("Electronics", 0), ("Mechanic", 0), ("Comms", 0), ("Vacc Suit", 0), ("Drive (loader)", 0),
                ("Str", 1), ("Dex", 1), ("End", 1), ("Int", 1), ("Edu", 1), ("Edu", 1),
                ("Investigate", 0), ("Drive", 0), ("Computers", 0), ("Sensors", 0), ("Engineer", 0), ("Jack of all Trades", 0),
