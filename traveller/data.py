...
HOSTILE = {
    'Corporate Agent': {
        'Intelligence': {'Surv': ('Dex', 5), 'Qual': ('Int', 6), 'Adv': ('Int', 7)}},# 'Com': ('Soc', 5), 'ReE': ('ReE', 5)}},
    'Marshal': {
        'Colonial Marshal': {'Surv': ('Dex', 6), 'Qual': ('Int', 7), 'Adv': ('Int', 7)}},# 'Com': ('Edu', 8), 'ReE': ('ReE', 5)}},
    'Physician': {
        'Medical': {'Surv': ('Int', 3), 'Qual': ('Int', 9), 'Adv': ('Edu', 8)}},# 'Com': ('Edu', 6), 'ReE': ('ReE', 4)}},
    'Military Spacer': {
        'PMC': {'Surv': ('Int', 5), 'Qual': ('Int', 6), 'Adv': ('Edu', 6)}},# 'Com': ('Soc', 7), 'ReE': ('ReE', 5)}},
    'Military Spacer Officer': {
        'PMC': {'Surv': ('Int', 5), 'Qual': ('Int', 6), 'Adv': ('Edu', 6)}},# 'Com': ('Soc', 7), 'ReE': ('ReE', 5)}},
    'Technician': {
        'Freelance Miner': {'Surv': ('Int', 4), 'Qual': ('Edu', 7), 'Adv': ('Edu', 8)}},# 'Com': ('Edu', 4), 'ReE': ('ReE', 5)}},
    'Marine': {
    ...
    'Commercial Spacer': {
        'Wanderer': {'Surv': ('Int', 5), 'Qual': ('Int', 4), 'Adv': ('Edu', 8)}},# 'Com': ('Int', 5), 'ReE': ('ReE', 4)}},
    'HOS_Rogue': {
        'Enforcer': {'Surv': ('Int', 6), 'Qual': ('End', 6), 'Adv': ('Int', 6)}},# 'Com': ('Str', 8), 'ReE': ('ReE', 5)}},
    'Roughneck': {
        'Freelance Miner': {'Surv': ('Int', 6), 'Qual': ('Dex', 8), 'Adv': ('End', 7)}},# 'Com': ('Str', 8), 'ReE': ('ReE', 7)}},
    'Colonist': {
        'UCC': {'Surv': ('End', 6), 'Qual': ('End', 5), 'Adv': ('Edu', 6)}},# 'Com': ('Int', 7), 'ReE': ('ReE', 5)}},
    'Corporate Executive': {
        'ICO': {'Surv': ('Soc', 4), 'Qual': ('Soc', 8), 'Adv': ('Int', 10)}},# 'Com': ('Edu', 5), 'ReE': ('ReE', 6)}},
    'Ranger': {
        'Action for Peace': {'Surv': ('Str', 6), 'Qual': ('End', 9), 'Adv': ('End', 6)}},# 'Com': ('Int', 5), 'ReE': ('ReE', 5)}},
    'Android': {
...
SKILLS = {
    ...
    ("Android", "Technician"): (("Engineer", 0), ("Electronics", 0),
                               ...
                               ("Computers", 0)),
    ("Corporate Agent", "Intelligence"): (("Str", 1), ("Dex", 1),
                               ("Persuade", 0), ("Int", 1), ("Edu", 1),
                               ("Soc", 1), ("Gun Combat", 0), ("Vacc Suit", 0), ("Drive", 0),
                               ("Streetwise", 0), ("Gun Combat", 0), ("Recon", 0),
                               ("Deception", 0), ("Investigate", 0), ("Computers", 0),
                               ("Carouse", 0), ("Comms", 0), ("Jack of all Trades", 0),
                               ("Medic", 0), ("Sensors", 0), ("Admin", 0),
                               ("Computers", 0), ("Leadership", 0),
                               ("Tactics", 0)),
    ("Corporate Executive", "ICO"): (("Streetwise", 0), ("Int", 1),
                               ("Edu", 1), ("Soc", 1), ("Carouse", 0),
                               ("Persuade", 0), ("Gambler", 0), ("Admin", 0),
                               ("Carouse", 0), ("Leadership", 0), ("Persuade", 0),
                               ("Deception", 0), ("Broker", 0), ("Diplomat", 0),
                               ("Drive", 0), ("Broker", 0), ("Computers", 0),
                               ("Leadership", 0), ("Medic", 0), ("Computers", 0),
                               ("Admin", 0), ("Diplomat", 0), ("Leadership", 0),
                               ("Jack of all Trades", 0)),
    ("Colonist", "UCC"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Int", 1), ("Melee (unarmed)", 0), ("Gun Combat", 0),
                               ("Mechanic", 0), ("Gun Combat", 0), ("Life Science", 0),
                               ("Electronics", 0), ("Survival", 0), ("Drive", 0),
                               ("Drive (loader)", 0), ("Carouse", 0), ("Jack of all Trades", 0),
                               ("Engineer", 0), ("Life Science", 0), ("Drive", 0),
                               ("Medic", 0), ("Life Science", 0),
                               ("Jack of all Trades", 0), ("Diplomat", 0), ("Admin", 0),
                               ("Leadership", 0)),
    ("Commercial Spacer", "Wanderer"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Str", 1), ("Melee (unarmed)", 0), ("Vacc Suit", 0),
                               ("Comms", 0), ("Persuade", 0), ("Gun Combat", 0),
                               ("Drive (loader)", 0), ("Broker", 0), ("Drive", 0),
                               ("Vacc Suit)", 0), ("Mechanic", 0), ("Drive (loader)", 0),
                               ("Electronics", 0), ("Steward", 0), ("Navigation", 0),
                               ("Medic", 0), ("Computers", 0),
                               ("Broker", 0), ("Pilot", 0), ("Engineer", 0),
                               ("Navigation", 0)),
    ("Marine", "USMC"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Gambler", 0), ("Melee (unarmed)", 0), ("Melee (blade)", 0),
                               ("Drive", 0), ("Vacc Suit", 0), ("Gun Combat", 0),
                               ("Survival", 0), ("Gun Combat", 0), ("Vacc Suit", 0),
                               ("Drive", 0), ("Mechanic", 0), ("Electrical", 0),
                               ("Explosives", 0), ("Recon", 0), ("Heavy Weapons", 0),
                               ("Medic", 0), ("Tactics", 0),
                               ("Tactics", 0), ("Computers", 0), ("Leadership", 0),
                               ("Admin", 0)),
    ("Marshal", "Colonial Marshal"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Int", 1), ("Edu", 1), ("Soc", 1),
                               ("Streetwise", 0), ("Melee (unarmed)", 0), ("Melee (unarmed)", 0),
                               ("Investigate", 0), ("Recon", 0), ("Gun Combat", 0),
                               ("Gun Combat", 0), ("Comms", 0), ("Drive", 0),
                               ("Sensors", 0), ("Computers", 0), ("Medic", 0),
                               ("Medic", 0), ("Tactics", 0),
                               ("Investigate", 0), ("Computers", 0), ("Tactics", 0),
                               ("Admin", 0)),
    ("Military Spacer", 'PMC'): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Int", 1), ("Edu", 1), ("Soc", 1),
                               ("Vacc Suit", 0), ("Computers", 0),
                               ("Vacc Suit", 0), ("Gunner", 0), ("Melee (unarmed)", 0),
                               ("Gun Combat", 0), ("Gunner", 0), ("Mechanic", 0),
                               ("Electronics", 0), ("Engineer", 0), ("Gunner", 0),
                               ("Comms", 0), ("Medic", 0),
                               ("Navigation", 0), ("Engineer", 0), ("Computers", 0),
                               ("Pilot", 0), ("Admin", 0)),
    ("Physician", "Medical"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Int", 1), ("Edu", 1), ("Soc", 1),
                               ("Dex", 1), ("Electronics", 0), ("Medic", 0),
                               ("Streetwise", 0), ("Medic", 0), ("Investigate", 0),
                               ("Diplomat", 0), ("Investigate", 0), ("Mechanic", 0),
                               ("Electronics", 0), ("Computers", 0), ("Admin", 0),
                               ("Diplomat", 0), ("Medic", 0), ("Admin", 0),
                               ("Computers", 0), ("Int", 1), ("Edu", 1)),
    ("Ranger", "Action for Peace"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Int", 1), ("Gun Combat", 0), ("Melee (blade)", 0),
                               ("Gun Combat", 0), ("Gun Combat", 0), ("Survival", 0),
                               ("Recon", 0), ("Drive", 0), ("Survival", 0),
                               ("Mechanic", 0), ("Electronics", 0), ("Comms", 0),
                               ("Recon", 0), ("Drive", 0), ("Survival", 0),
                               ("Medic", 0), ("Computers", 0), ("Jack of all Trades", 0),
                               ("Leadership", 0), ("Medic", 0), ("Mechanic", 0)),
    ("HOS_Rogue", "Enforcer"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Melee (unarmed)", 0), ("Melee (blade)", 0), ("Carouse", 0),
                               ("Melee (blade)", 0), ("Gun Combat", 0), ("Melee (unarmed)", 0),
                               ("Drive", 0), ("Recon", 0), ("Drive", 0),
                               ("Streetwise", 0), ("Persuade", 0), ("Deception", 0),
                               ("Explosives", 0), ("Sensors", 0), ("Melee (blade)", 0),
                               ("Tactics", 0), ("Persuade", 0), ("Deception", 0),
                               ("Computers", 0), ("Leadership", 0), ("Jack of all Trades", 0)),
    ("Roughneck", "Freelance Miner"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Gambler", 0), ("Vacc Suit", 0), ("Melee (unarmed)", 0),
                               ("Vacc Suit", 0), ("Mining", 0), ("Vacc Suit", 0),
                               ("Explosives", 0), ("Comms", 0), ("Drive", 0),
                               ("Streetwise", 0), ("Electronics", 0), ("Drive", 0),
                               ("Mechanic", 0), ("Mining", 0), ("Mechanic", 0),
                               ("Navigation", 0), ("Medic", 0), ("Electronics", 0),
                               ("Computers", 0), ("Engineer", 0), ("Jack of all Trades", 0)),
    ("Scientist", "ICO"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Int", 1), ("Edu", 1), ("Int", 1),
                               ("Gun Combat", 0), ("Comms", 0), ("Investigate", 0),
                               ("Drive", 0), ("Comms", 0), ("Survival", 0),
                               ("Mechanic", 0), ("Electronics", 0), ("Vacc Suit", 0),
                               ("Computers", 0), ("Investigate", 0), ("Drive", 0),
                               ("Medic", 0), ("Computers", 0), ("Admin", 0),
                               ("Leadership", 0), ("Navigation", 0), ("Jack of all Trades", 0)),
    ("Survey Scout", "MRA"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Int", 1), ("Edu", 1), ("Gun Combat", 0),
                               ("Drive", 0), ("Vacc Suit", 0), ("Mechanic", 0),
                               ("Mining", 0), ("Comms", 0), ("Mining", 0),
                               ("Drive", 0), ("Mechanic", 0), ("Electronics", 0),
                               ("Investigate", 0), ("Gunner", 0), ("Medic", 0),
                               ("Medic", 0), ("Navigation", 0), ("Engineer", 0),
                               ("Computers", 0), ("Pilot", 0), ("Jack of all Trades", 0)),
    ("Technician", "Freelance Miner"): (("Str", 1), ("Dex", 1),
                               ("End", 1), ("Int", 1), ("Edu", 1), ("Edu", 1),
                               ("Drive", 0), ("Electronics", 0), ("Mechanic", 0),
                               ("Comms", 0), ("Vacc Suit", 0), ("Drive (loader)", 0),
                               ("Investigate", 0), ("Drive", 0), ("Computers", 0),
                               ("Sensors", 0), ("Engineer", 0), ("Jack of all Trades", 0),
                               ("Mechanic", 0), ("Computers", 0), ("Admin", 0),
                               ("Electronics", 0), ("Engineer", 0), ("Jack of all Trades", 0)),
}
...
RANKS = {
    ...
    ("Technician", "Freelance Miner"):
        (("Mechanic", 1), None, None, None, None, None, None),
}
